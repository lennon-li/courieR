...
[`ship`](https://lennon-li.github.io/courieR/reference/ship.md) directly
if you need fine-grained control.

## Usage

``` r
migrate(from, to, dry_run = FALSE, upgrade = TRUE, ...)
```
...
[`ship`](https://lennon-li.github.io/courieR/reference/ship.md): `plan`,
`results`, `comparison`, `dry_run`, `elapsed_sec`.
