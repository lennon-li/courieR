test_that("compare_libraries classifies correctly", {
...
test_that("detect_install_source works", {
  expect_equal(detect_install_source("pkg"), "pkg")
  expect_equal(detect_install_source("pkg", "1.0.0"), "pkg@1.0.0")
  expect_equal(detect_install_source("pkg", source_hint = "Bioconductor"), "bioc::pkg")
  expect_equal(detect_install_source("pkg", source_hint = "GitHub", github_ref = "user/pkg@main"), "user/pkg@main")
})