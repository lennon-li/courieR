...
```{r sync-screenshot, echo=FALSE, out.width="100%", fig.cap="The Sync tab: pick a source and a target R installation, compare their libraries, and ship packages from source into target. The log pane on the right shows real-time progress."}
...
The Advanced tab exposes `manifest()` output and lets you inspect any detected R installation's full package list.
