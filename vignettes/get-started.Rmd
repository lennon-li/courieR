...
```{r sync-screenshot, echo=FALSE, out.width="100%", fig.cap="The Sync tab: select two R installations, compare their libraries, and sync in either direction. The log pane on the right shows real-time progress."}
...
2. Select two installations from the sidebar dropdowns (labelled A and B).
